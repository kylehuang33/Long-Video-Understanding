...
#SBATCH --output=slurm-%j-long.out
#SBATCH --error=slurm-%j-long.err
...
OUTPUT_PATH="./captions_long.json"
PROMPT_STYLE="LONG"
MODEL_PATH="Qwen/Qwen3-VL-4B-Instruct"
MAX_NEW_TOKENS=512

echo "========================================"
echo "Qwen3VL Image Captioning - LONG"
echo "========================================"
